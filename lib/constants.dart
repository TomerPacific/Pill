...
const String PILL_DESCRIPTION_KEY = "description";
const String PILL_AMOUNT_OF_DAYS_TO_TAKE_KEY = "amountOfDaysToTake";
const String PILL_LAST_TAKEN_KEY = "lastTaken";
const String APP_TITLE = "Pill";
...
const double IMAGE_WIDTH_FACTOR = 0.6;
